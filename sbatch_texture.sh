...
#SBATCH --error=outputs/test_%j.err
...
export BLENDER_HOME="/home/${USER}/blender-3.0.1-linux-x64/blender"
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True

SPACEFLOW_SCRATCH="${SPACEFLOW_SCRATCH:-/work/scratch/${USER}}"
...
srun --ntasks=1 --export=ALL \
  ...
  --convert_yup_to_zup \
  --shape_superquadric_path examples/superquadrics/cop_sq.npz \
  --shape_tau 6.0 \
  --text_prompt "A supercar" \
  --local_image_paths '[null, null, null, null, null, null, "examples/police.png"]' \
