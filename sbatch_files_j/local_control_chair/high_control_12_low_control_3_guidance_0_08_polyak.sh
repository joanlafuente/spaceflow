...
srun --ntasks=1 --export=ALL \
  ...
  --output_dir outputs/local_control_chair/high_control_10_low_control_3_guidance_0_08_polyak \
  --shape_superquadric_path examples/superquadrics/low_control_chair_v2.npz \
  --shape_tau 3.0 \
  --convert_yup_to_zup \
  --shape_superquadric_high_control_path examples/superquadrics/high_control_chair_v2.npz \
