...
RUN_NAME="local_control_sofa_v2"
LOW_CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/sofa_local_control_v2/sofa_v2_low_control.npz"
HIGH_CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/sofa_local_control_v2/sofa_v2_high_control.npz"
...
srun --ntasks=1 --export=ALL \
  ...
  --output_dir outputs/$RUN_NAME/high_control_10_low_control_3_guidance_0_08_polyak_with_video \
