...
RUN_NAME="local_control_weird_chair_bb_legs_high_controll_pulling"
CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/wierd_chair/weird_chair_corrected.npz"
LOW_CONTROL_SUPERQUADRIC_MASK_PATH="examples/superquadrics/wierd_chair/weird_chair_leg_bb_corrected.npz"
HIGH_CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/wierd_chair/weird_chair_high_control_part_corrected.npz"
...
srun --ntasks=1 --export=ALL \
  ...
  --output_dir "outputs/$RUN_NAME/high_control_10_low_control_3_low_control_mask_0_18_high_control_latents_pulling_dilation_3_corrected_rotation" \
