...
srun --ntasks=1 --export=ALL \
  ...
  --output_dir outputs/local_control_sofa/high_control_10_low_control_3_guidance_0_08_polyak \
  --shape_superquadric_path examples/superquadrics/sofa_local_control/complete_sofa.npz \
  --shape_tau 3.0 \
  --convert_yup_to_zup \
  --shape_superquadric_high_control_path examples/superquadrics/sofa_local_control/only_pillows.npz \
  --shape_tau_high_control 10.0 \
  --text_prompt "A sofa with pillows" \
