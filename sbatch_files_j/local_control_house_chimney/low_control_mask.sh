...
CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/house_v2_local_control/house_v2_low_control.npz"
LOW_CONTROL_SUPERQUADRIC_MASK_PATH="examples/superquadrics/house_v2_local_control/low_control_area.npz"
