...
RUN_NAME="local_control_house"
# Names of the files are messed up in this case 
LOW_CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/house_local_control/house_high_control.npz"
...
srun --ntasks=1 --export=ALL \
  ...
  --shape_superquadric_path $HIGH_CONTROL_SUPERQUADRIC_PATH \
  --shape_tau 3.0 \
  --convert_yup_to_zup \
  --text_prompt $TEXT_PROMPT \
