...
RUN_NAME="local_control_house_chimney_test_polyak_binarized_mask"
CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/house_local_control/house_high_control.npz"
LOW_CONTROL_SUPERQUADRIC_MASK_PATH="examples/superquadrics/house_local_control/low_control_area.npz"
HIGH_CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/house_local_control/house_low_control.npz"
