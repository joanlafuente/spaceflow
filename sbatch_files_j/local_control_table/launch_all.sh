...
RUN_NAME="local_control_table"
LOW_CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/table_local_control/table_low_control.npz"
HIGH_CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/table_local_control/table_high_control.npz"
APPEARANCE_IMAGE="examples/table.jpg"
TEXT_PROMPT="Wood table with a plant on top"
