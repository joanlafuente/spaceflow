...
RUN_NAME="local_control_table_2_step_gen_2_test_0_325_polyak_binarized_mask_no_noise"
CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/table_local_control_2_step_gen/table_with_object.npz"
LOW_CONTROL_SUPERQUADRIC_MASK_PATH="examples/superquadrics/table_local_control_2_step_gen/low_control_area.npz"
HIGH_CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/table_local_control_2_step_gen/table.npz"
