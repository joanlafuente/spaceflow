...
#SBATCH --job-name=wood-toy-reg
#SBATCH --array=0-2
#SBATCH --output=/work/courses/3dv/team3/spaceflow/outputs/local_control_wood_toy_prompt_variations_10_regular_space_control/logs/%x_%A_%a.out
#SBATCH --error=/work/courses/3dv/team3/spaceflow/outputs/local_control_wood_toy_prompt_variations_10_regular_space_control/logs/%x_%A_%a.err
...
RUN_NAME="local_control_wood_toy_prompt_variations_10_regular_space_control"
CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/wood_person_toy/wood_person.npz"
APPEARANCE_IMAGE="examples/table.jpg"
SHAPE_TAU="${SHAPE_TAU:-3.0}"
TAU_SLUG="tau_${SHAPE_TAU//./_}"
...
OUTPUT_DIR="outputs/${RUN_NAME}/${TAU_SLUG}/${VARIANT}/regular_space_control"
