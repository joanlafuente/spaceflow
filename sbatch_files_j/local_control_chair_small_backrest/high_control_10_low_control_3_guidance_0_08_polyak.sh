...
srun --ntasks=1 --export=ALL \
  ...
  --output_dir outputs/local_control_chair_small_backrest/high_control_10_low_control_3_guidance_0_08_polyak \
  --shape_superquadric_path examples/superquadrics/chair_w_small_backrest_low.npz \
  --shape_tau 3.0 \
  --convert_yup_to_zup \
  --shape_superquadric_high_control_path examples/superquadrics/chair_w_small_backrest_high.npz \
