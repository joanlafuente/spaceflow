...
RUN_NAME="local_control_chair_small_backrest"
CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/chair_w_small_backrest_low.npz"
LOW_CONTROL_SUPERQUADRIC_MASK_PATH="examples/superquadrics/low_control_area_chair.npz"
