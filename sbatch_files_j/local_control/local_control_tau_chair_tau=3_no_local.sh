...
srun --ntasks=1 --export=ALL \
  ...
  --appearance_image examples/ref_img.jpg \
  --output_dir outputs/local_control_tau_chair_tau_3_no_local \
  --shape_superquadric_path examples/superquadrics/Chair_low_control.npz \
  --shape_tau 3.0 \
  --convert_yup_to_zup \
  --shape_superquadric_high_control_path examples/superquadrics/Chair_high_control.npz \
  --shape_tau_high_control 12.0 \
  --polyak_update_tau 0.00 \
  --text_prompt "A chair" \