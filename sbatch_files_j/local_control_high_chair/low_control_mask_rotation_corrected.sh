...
CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/high_chair/high_chair_rotation_corrected.npz"
LOW_CONTROL_SUPERQUADRIC_MASK_PATH="examples/superquadrics/high_chair/legs_bb.npz"
HIGH_CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/high_chair/backrest_high_control.npz"
