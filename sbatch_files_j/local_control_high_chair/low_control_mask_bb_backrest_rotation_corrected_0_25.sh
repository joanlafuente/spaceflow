...
LOW_CONTROL_SUPERQUADRIC_MASK_PATH="examples/superquadrics/high_chair/backrest_bb.npz"
HIGH_CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/high_chair/legs_high_control.npz"
