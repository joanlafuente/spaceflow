...
CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/high_chair/high_chair_rotation_corrected_v3.npz"
LOW_CONTROL_SUPERQUADRIC_MASK_PATH="examples/superquadrics/high_chair/bb_legs_v2.npz"
HIGH_CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/high_chair/high_chair_backrest_v2.npz"
...
srun --ntasks=1 --export=ALL \
  ...
  --output_dir "outputs/$RUN_NAME/high_control_10_low_control_3_low_control_mask_0_18_high_control_latents_pulling_dilation_3_rotated_input" \
