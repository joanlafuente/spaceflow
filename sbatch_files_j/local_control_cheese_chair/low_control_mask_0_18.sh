...
RUN_NAME="local_control_cheese_chair"
CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/cheese_chair/cheese_chair_corrected_v2.npz"
LOW_CONTROL_SUPERQUADRIC_MASK_PATH="examples/superquadrics/cheese_chair/bb_legs_corrected_v2.npz"
HIGH_CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/cheese_chair/cheese_chair_backrest_v2.npz"
...
srun --ntasks=1 --export=ALL \
  ...
  --output_dir "outputs/$RUN_NAME/high_control_10_low_control_3_low_control_mask_0_18_high_control_latents_pulling_dilation_3_corrected_rotation_v2" \
