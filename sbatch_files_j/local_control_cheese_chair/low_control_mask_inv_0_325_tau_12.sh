...
RUN_NAME="local_control_cheese_chair_inv_test_0_325_polyak_binarized_mask_tau_12"
CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/cheese_chair/cheese_chair.npz"
LOW_CONTROL_SUPERQUADRIC_MASK_PATH="examples/superquadrics/cheese_chair/bb_legs.npz"
