...
RUN_NAME="local_control_nightstand"
CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/nightstand_local_control/nightstand_with_lamp_v2.npz"
LOW_CONTROL_SUPERQUADRIC_MASK_PATH="examples/superquadrics/nightstand_local_control/low_control_area_v2.npz"
...
srun --ntasks=1 --export=ALL \
  ...
  --output_dir "outputs/$RUN_NAME/high_control_10_low_control_3_low_control_mask_0_30_high_control_latents_pulling" \
