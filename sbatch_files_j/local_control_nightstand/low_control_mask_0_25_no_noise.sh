...
RUN_NAME="local_control_nightstand_test_0_25_polyak_binarized_mask_no_noise"
CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/nightstand_local_control/nightstand_with_lamp_v2.npz"
LOW_CONTROL_SUPERQUADRIC_MASK_PATH="examples/superquadrics/nightstand_local_control/low_control_area.npz"
HIGH_CONTROL_SUPERQUADRIC_PATH="examples/superquadrics/nightstand_local_control/nightstand.npz"
APPEARANCE_IMAGE="examples/table.jpg"
TEXT_PROMPT="A nightstand with a lamp on top"
...
srun --ntasks=1 --export=ALL \
  ...
  --output_dir "outputs/$RUN_NAME/high_control_10_low_control_3_low_control_mask_dilation_3_polyak_0_18" \
